        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6">  
                            <h3 class="no-margin">All Clinic List </h3>
                       ...
                       <a href="<%=Common_Things.url%>/add-clinic/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna"%>" class="btn btn-info">Add Clinic Details</a>
                        ...
                        <a href="<%=Common_Things.url%>/view-all-clinic/<%=12%>" class="btn btn-info">View Clinic List</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-heading">View Clinic List
                                ...
                                <ul class="list-group">
                                	...
                                	<%
                                                                                                                                                      	Clinic_Table_Model obj_Clinic_Table_Model=new Clinic_Table_Model();  
                                                                                                                                                      	                                                                                                                                                      	                       	                  	List<Clinic_Use_Bean> list_clinic=obj_Clinic_Table_Model.get_all_clinic(int_lim);
                                	...
                                	%>
		                              ...
		                              <%
		                              					if(int_lim==1){
		                              %>
		            	          						 <a href="<%=Common_Things.url %>/view-all-clinic/?lim=<%=0 %>"  class="btn btn-danger btn-xs">Previous</a>
                     											
		                              <%						
		                              					}else if(int_lim!=0){    
		                              %>
		            	          								<a href="<%=Common_Things.url %>/view-all-clinic/?lim=<%=int_lim-1 %>"  class="btn btn-danger btn-xs">Previous</a>
		                              ...
		                              %>  			
		                							...
		                							<td>
		                                				   <a href="<%=Common_Things.url %>/view-all-clinic/?lim=<%=int_lim+1 %>"  class="btn btn-danger btn-xs">Next</a>
