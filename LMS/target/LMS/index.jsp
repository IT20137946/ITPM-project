...
<meta http-equiv="Content-Type" content="text/html; charset=ISO-8859-1">
 ...
 <!-- meta -->
    ...
    <!-- bootstrap -->
    <link rel="stylesheet" href="<%=common.Common_Things.url %>/bootstrap/css/bootstrap.min.css">
    <!-- /bootstrap -->

    <!-- core styles -->
    <link rel="stylesheet" href="<%=common.Common_Things.url %>/css/main.css">
    <!-- /core styles -->
...
<body>	
	...
	%>
				            ...
				            <section class="panel panel-default">
				                <header class="panel-heading"><%=" Kadugoda Kanishta Vidyalaya" %></header>
