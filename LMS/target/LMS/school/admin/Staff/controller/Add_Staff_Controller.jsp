...
<jsp:useBean id="obj_Staff_Use_Bean" class="common_use_bean.Staff_Use_Bean"></jsp:useBean>
	...
	Staff_Table_Model obj_Staff_Table_Model=new Staff_Table_Model();
	   ...
	   int flag=obj_Staff_Table_Model.insert_staff(obj_Staff_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("add_staff_message","Staff Added Successfully");
		...
		%>
		  		 ...
		  		 <script type="text/javascript">
						window.location.href="<%=Common_Things.url%>/add-staff/";
				</script>
