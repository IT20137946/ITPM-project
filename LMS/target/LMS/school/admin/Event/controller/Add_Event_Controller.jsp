...
<jsp:useBean id="obj_Event_Use_Bean" class="common_use_bean.Event_Use_Bean"></jsp:useBean>
	...
	Event_Table_Model obj_Event_Table_Model=new Event_Table_Model();
	   ...
	   int flag=obj_Event_Table_Model.insert_event(obj_Event_Use_Bean);
	   
	   if(flag==1){
		   
			
			session.setAttribute("add_event_message","Event Added Successfully");
		...
		%>
		  		 ...
		  		 <script type="text/javascript">
						window.location.href="<%=Common_Things.url%>/add-event/";
				</script>
