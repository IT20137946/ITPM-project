                                                    ...
                                                    <form action="<%=Common_Things.url%>/admin-add-book-controller" class="form-horizontal" role="form" name="myForm"  onsubmit="return validateForm()">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Book Title* </label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" id="book_title"  name="book_title" data-parsley-required="true" data-parsley-trigger="change" placeholder="Book Title"  required>
                                                               </div> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Author" name="author_name" required>
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Publisher" name="publisher_name" required>
                                                            </div>
                                                        </div>
                                                        <hr> 
                                                        ...
                                                        <hr> 
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="EAN Code" name="ean_code" required>
                                                            </div>
                                                        </div>
                                                        <hr> 
