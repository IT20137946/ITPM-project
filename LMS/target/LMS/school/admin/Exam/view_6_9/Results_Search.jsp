...
/*                            			                           				Exam_Table_Model.Exam_Table_6_9_Model obj_Exam_Table_Model=new Exam_Table_Model.Exam_Table_6_9_Model();
 */                           			                           			        	
/*                            			                           			        	List<Exam_Use_Bean_6_9> list_exam_results=obj_Exam_Table_Model.get_all_exam_detail_from_student_id(student_id);
 */                           			%>
										...
										<div class="col-lg-6">
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/results-search/" class="form-horizontal" role="form">
											...
											<table class="table table-hover no-margin">
												...
												<tbody>
													...
													<%
   			                           				...
   			                           				Exam_Table_Model.Exam_Table_6_9_Model obj_Exam_Table_Model=new Exam_Table_Model.Exam_Table_6_9_Model();
		                       	                  	List<Exam_Use_Bean_6_9> list_exam_results=obj_Exam_Table_Model.search_result_exam(search);
		                       	                                			...
		                       	                                			if(list_exam_results!=null){
              	                       	                                		...
              	                       	                                		Iterator<Exam_Use_Bean_6_9> it_exam_results=list_exam_results.iterator();
              	                       	                                		Exam_Use_Bean_6_9 obj_Exam_Results_Bean=new Exam_Use_Bean_6_9();
              	                       	                                	int temp_count=1;
													...
													<tr>
														...
														<td><%=obj_Exam_Results_Bean.getGeography() %></td>
														<td><%=obj_Exam_Results_Bean.getCivic_education() %></td>
														<td><%=obj_Exam_Results_Bean.getHealth() %></td>
														<td><%=obj_Exam_Results_Bean.getTamil() %></td>
														<td><%=obj_Exam_Results_Bean.getPts() %></td>
														<td><%=obj_Exam_Results_Bean.getBucket_subject() %></td>
