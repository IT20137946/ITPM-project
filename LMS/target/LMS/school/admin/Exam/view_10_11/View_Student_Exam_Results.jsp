        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-8"> 
                            <h3 class="no-margin">Exam Results : <b><%=student_name%></b></h3>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-heading">Exam Results Details
                                ...
                                <ul class="list-group">
                                	...
                                	<%
                                               ...
                                               <td><a href="<%=Common_Things.url %>/update-exam-results-10-11/?eid=<%=obj_Exam_Results_Bean.getExam_id() %> " class="btn btn-success btn-xs">Update</a> </td> 
