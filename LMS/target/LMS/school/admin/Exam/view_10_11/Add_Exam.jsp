		...
		<section class="main-content">
			...
			<div class="content-wrap">
				...
				<div class="col-lg-6">
					...
					<section class="panel">
						<header class="panel-heading">Add Exam Result Grade 10 -
							11</header>
						<div class="panel-body">

							<form action="<%=Common_Things.url%>/exam-result-controller-10-11/"
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control"
											placeholder="Semester | 1, 2 or 3" data-toggle="tooltip" data-placement="bottom" title="Semester | 1, 2 or 3" name="semester" required>
									</div>
								</div>
								<hr>
								<hr>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control"
											placeholder="Bucket Subject 01" name="bucket_subject_01" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control"
											placeholder="Bucket Subject 02" name="bucket_subject_02" required>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" class="form-control"
											placeholder="Bucket Subject 03" name="bucket_subject_03" required>
									</div>
								</div>
						</div>
						<hr>
