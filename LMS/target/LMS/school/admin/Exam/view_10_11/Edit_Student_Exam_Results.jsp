...
<body>
	...
	<%
                          			String exam_id=(String)request.getParameter("eid");
                          			                          					Exam_Table_Model.Exam_Table_10_11_Model obj_ExamTable_Model=new Exam_Table_Model.Exam_Table_10_11_Model();
                          			                          				
                          			                          					Exam_Use_Bean_10_11 obj_Exam_Results_Use_Bean=obj_ExamTable_Model.get_complete_exam_results_details_student(exam_id);
				...
				<div class="col-lg-6">
					...
					<section class="panel">
						...
						<div class="panel-body">
							...
							<form action="<%=Common_Things.url%>/edit-exam-result-controller-10-11/?sid=<%=student_id%>"
...
<hr>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">Bucket Subject 01</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="Bucket Subject 01"
											name="bucket_subject_01" value="<%=obj_Exam_Results_Use_Bean.getBucket_subject_01()%>">
									</div>
								</div>
								<hr>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">Bucket Subject 02</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="Bucket Subject 02"
											name="bucket_subject_02" value="<%=obj_Exam_Results_Use_Bean.getBucket_subject_02()%>">
									</div>
								</div>
									<hr>
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-2 control-label">Bucket Subject 03</label>
									<div class="col-sm-10">
										<input type="text" class="form-control" placeholder="Bucket Subject 03"
											name="bucket_subject_03" value="<%=obj_Exam_Results_Use_Bean.getBucket_subject_03()%>">
									</div>
								</div>
								<hr>
