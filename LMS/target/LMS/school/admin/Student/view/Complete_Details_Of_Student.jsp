                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        ...
                        <a href="<%=Common_Things.url %>/issue-book-student/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-warning">Issue Book</a>
                      	<a href="<%=Common_Things.url %>/exam-result/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-warning">Add Result 6-9</a>
                      	<a href="<%=Common_Things.url %>/exam-result-10-11/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-warning">Add Result 10-11</a>
                      	 <a href="<%=Common_Things.url %>/exam-results-student/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-primary">Result 6-9</a>
                      	<a href="<%=Common_Things.url %>/exam-results-student-10-11/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-primary">Result 10-11</a>
                      	<a href="<%=Common_Things.url %>/add-hostel/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-primary">Add Hostel</a>
                      	<a href="<%=Common_Things.url %>/hostel-details/?id=<%=obj_Student_Use_Bean.getStudent_id() %>&n=<%=obj_Student_Use_Bean.getStudent_name() %>&ad=<%=obj_Student_Use_Bean.getAdmission_no() %>" class="btn btn-primary">Hostel Details</a>
                                                        ...
                                                        <div class="form-group">
                                                         ...
                                                         <div class="form-group">
                                                          ...
                                                          <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Address" name="address" value="<%if(obj_Student_Use_Bean.getAddress()!=null){out.println(obj_Student_Use_Bean.getAddress());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                       <hr> 
                                                          ...
                                                          <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="MM/DD/YYYY" name="dob" value="<%if(obj_Student_Use_Bean.getDob()!=null){out.println(obj_Student_Use_Bean.getDob());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                       <hr> 
                                                          ...
                                                          <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Contact Number" name="phone_number" value="<%if(obj_Student_Use_Bean.getPhone_number()!=null){out.println(obj_Student_Use_Bean.getPhone_number());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                     ...
                                                     <hr>  
                                                        ...
                                                        <div class="form-group">  
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                ...
                                                                <a href="<%=Common_Things.url %>/delete-profile-student/?lm=<%=obj_Student_Use_Bean.getStudent_id() %>" class="btn btn-danger">Delete Profile</a>
