                                                      ...
                                                      <input type="hidden" name="student_id" value="<%=Student_id %>">
                                                        ...
                                                        <hr> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Address" name="address" value="<%if(obj_Student_Use_Bean.getAddress()!=null){out.println(obj_Student_Use_Bean.getAddress());} %>" >
                                                            </div>
                                                        </div>
                                                        <hr> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="MM/DD/YYYY" name="dob" value="<%if(obj_Student_Use_Bean.getDob()!=null){out.println(obj_Student_Use_Bean.getDob());} %>" >
                                                            </div>
                                                        </div>
                                                       <hr> 
                                                       <hr> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Contact Number" name="phone_number" value="<%if(obj_Student_Use_Bean.getPhone_number()!=null){out.println(obj_Student_Use_Bean.getPhone_number());} %>" >
                                                            </div>
                                                        </div>
