				...
				<div class="col-lg-6">
					...
					<section class="panel">
						...
						<div class="panel-body">
							...
							<form action="<%=Common_Things.url%>/hostel-controller/"
								...
								<div class="form-group">
								 ...
								 <hr>  
                                                      <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                    <label> 
                                                                        <input type="radio" name="status" value="1" checked="checked">Male
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-15">
								<button type="submit" class="btn btn-default">Add Hostel Details</button>
							</div>
						</div>
