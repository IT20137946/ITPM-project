...
<body>
	...
	if(list1==null){
		...
		session.setAttribute("ss_hospital_index_message","Opps..Your session expired,Please Login Again");
	%>
...
<title>Hospital Management System | SLIIT</title>
            ...
            <aside class="sidebar canvas-left bg-dark">
                <!-- main navigation -->
								                    ...
								                    <ul>
								                        ...
								                        <li>
								                            <a href="<%=Common_Things.url %>/doc-search/">
								                        ...
								                        <li>
								                            <a href="<%=Common_Things.url %>/emp-search/">
								                                <i class="fa fa-users"></i>
								                        ...
								                        <li>
								                            <a href="<%=Common_Things.url %>/clinic-search/">
								                                <i class="fa fa-users"></i>
