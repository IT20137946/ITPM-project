...
<body>
    ...
    <div class="app" data-sidebar="locked">
		...
		<%
                          		String Employee_id=(String)request.getParameter("lm");
                          		                          		                          		                          				Emp_Table_Model obj_Emp_Table_Model=new Emp_Table_Model();
                          		                          		                          		                          				
                          		                          		                          		                          				Employee_Use_Bean obj_Emp_Use_Bean=obj_Emp_Table_Model.get_complete_details_emp(Employee_id);
                          		%>
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin">Employee Name:<%=obj_Emp_Use_Bean.getEmp_name() %></h3>
                            
                        </div>
                        <a href="<%=Common_Things.url %>/emp-search/?kou=<%=12 %>" class="btn btn-info">Search Employee</a>
							...
							%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/edit-profile-emp-controller/" class="form-horizontal" role="form">
                                                      <input type="hidden" name="emp_id" value="<%=Employee_id %>">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Employee No</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="emp_no" data-parsley-required="true" data-parsley-trigger="change" placeholder="Employee No" value="<%if(obj_Emp_Use_Bean.getEmp_no()!=null){out.println(obj_Emp_Use_Bean.getEmp_no());} %>" >
                                                               </div> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Employee Name" name="emp_name" value="<%if(obj_Emp_Use_Bean.getEmp_name()!=null){out.println(obj_Emp_Use_Bean.getEmp_name());} %>" >
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="NIC" name="nic" value="<%if(obj_Emp_Use_Bean.getNic()!=null){out.println(obj_Emp_Use_Bean.getNic());} %>" >
                                                            </div>
                                                        </div>
                                                        ...
                                                        <hr> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Address" name="address" value="<%if(obj_Emp_Use_Bean.getAddress()!=null){out.println(obj_Emp_Use_Bean.getAddress());} %>" >
                                                            </div>
                                                        </div>
                                                        <hr> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="MM/DD/YYYY" name="dob" value="<%if(obj_Emp_Use_Bean.getDob()!=null){out.println(obj_Emp_Use_Bean.getDob());} %>" >
                                                            </div>
                                                        </div>
                                                       <hr> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Contact Number" name="contact_no" value="<%if(obj_Emp_Use_Bean.getContact_no()!=null){out.println(obj_Emp_Use_Bean.getContact_no());} %>" >
                                                            </div>
                                                        </div>
                                                        <hr>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                         			...
                                                         			if(obj_Emp_Use_Bean.getGender()==1){
                                                        ...
                                                        <hr> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="email" class="form-control" placeholder="Email" name="email" value="<%if(obj_Emp_Use_Bean.getEmail()!=null){out.println(obj_Emp_Use_Bean.getEmail());} %>" >
                                                            </div>
                                                        </div>
