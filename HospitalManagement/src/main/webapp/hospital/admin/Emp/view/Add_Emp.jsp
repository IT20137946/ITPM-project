    ...
    <script src="<%=request.getContextPath()%>/vendor/modernizr.js"></script>
     ...
     <script type="text/javascript">
		function validateForm() {
		    var x = empument.forms["myForm"]["admission_no"].value;
		    if (x==null || x=="") {
		    ...
		    var x = empument.forms["myForm"]["patient_name"].value;
		    if (x==null || x=="") {
		    ...
		    var x = empument.forms["myForm"]["nic"].value;
		    if (x==null || x=="") {
        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin">Add Employee Details</h3>
                    ...
                    <div class="col-lg-8">
							...
							%>
                                            ...
                                            <section class="panel">
                                                <header class="panel-heading">Add Employee Details Form</header>
                                                <div class="panel-body">

                                                    <form action="<%=Common_Things.url%>/add-emp-control/" class="form-horizontal" role="form" name="myForm"  onsubmit="return validateForm()">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Employee NO</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="emp_no" data-parsley-required="true" data-parsley-trigger="change" placeholder="Employee NO" required>
                                                               </div> 
