        ...
        <!-- top header -->
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6">  
                            <h3 class="no-margin">All Doctor List </h3>
                       ...
                       <a href="<%=Common_Things.url%>/add-doc/?kou=<%="232323243kihnadfhlacfhdkaudfhnakcdfchakdfhbkavhdfhna"%>" class="btn btn-info">Add Doctor Details</a>
                        ...
                        <a href="<%=Common_Things.url%>/view-all-doc/<%=12%>" class="btn btn-info">View Doctor List</a>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <section class="panel">
                                ...
                                <div class="panel-heading">View Doctor List
                                ...
                                <ul class="list-group">
                                	...
                                	<%
                                                                                                                                                      	Doc_Table_Model obj_Doc_Table_Model=new Doc_Table_Model();  
                                                                                                                                                      	                                                                                                                                                      	                                                                                                                                                      	                                                                                                                                                      	                       	                  	List<Doc_Use_Bean> list_doc=obj_Doc_Table_Model.get_all_doc(int_lim);
                                	...
                                	%>
		                              ...
		                              <%
		                              					if(int_lim==1){
		                              %>
		            	          						 <a href="<%=Common_Things.url %>/view-all-doc/?lim=<%=0 %>"  class="btn btn-danger btn-xs">Previous</a>
                     											
		                              <%						
		                              					}else if(int_lim!=0){    
		                              %>
		            	          								<a href="<%=Common_Things.url %>/view-all-doc/?lim=<%=int_lim-1 %>"  class="btn btn-danger btn-xs">Previous</a>
		                              ...
		                              %>  			
		                							...
		                							<td>
		                                				   <a href="<%=Common_Things.url %>/view-all-doc/?lim=<%=int_lim+1 %>"  class="btn btn-danger btn-xs">Next</a>
