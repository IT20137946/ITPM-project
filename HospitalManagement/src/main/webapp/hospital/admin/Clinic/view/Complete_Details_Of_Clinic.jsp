		...
		<%
            ...
            <section class="main-content">
                ...
                <div class="content-wrap">
                    ...
                    <div class="row mg-b">
                        <div class="col-xs-6"> 
                            <h3 class="no-margin">Patient :<%=obj_Clinic_Use_Bean.getPatient_name() %></h3>
							...
							%>
                                            ...
                                            <section class="panel">
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <form action="<%=Common_Things.url%>/add-clinic-contro/" class="form-horizontal" role="form">
                                                        <div class="form-group">
                                                            <label for="inputEmail3" class="col-sm-2 control-label">Clinic NO</label>
                                                            	<div class="col-sm-10">
                                                               	<input type="text" class="form-control" name="clinic_no" data-parsley-required="true" data-parsley-trigger="change" placeholder="Clinic No" value="<%if(obj_Clinic_Use_Bean.getClinic_no()!=null){out.println(obj_Clinic_Use_Bean.getClinic_no());} %>" readonly="readonly">
                                                               </div> 
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Name" name="patient_name" value="<%if(obj_Clinic_Use_Bean.getPatient_name()!=null){out.println(obj_Clinic_Use_Bean.getPatient_name());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Clinic Type" name="type" value="<%if(obj_Clinic_Use_Bean.getType()!=null){out.println(obj_Clinic_Use_Bean.getType());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                         ...
                                                         <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Doctor Name" name="doctor_name" value="<%if(obj_Clinic_Use_Bean.getDoctor_name()!=null){out.println(obj_Clinic_Use_Bean.getDoctor_name());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                         ...
                                                         <hr> 
                                                          ...
                                                          <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="MM/DD/YYYY" name="doc" value="<%if(obj_Clinic_Use_Bean.getDoc()!=null){out.println(obj_Clinic_Use_Bean.getDoc());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                          ...
                                                          <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" placeholder="Time" name="time" value="<%if(obj_Clinic_Use_Bean.getTime()!=null){out.println(obj_Clinic_Use_Bean.getTime());} %>" readonly="readonly">
                                                            </div>
                                                        </div>
                                                     ...
                                                     <hr>  
                                                        ...
                                                        <div class="form-group">  
                                                            <div class="col-sm-offset-2 col-sm-15">
                                                                ...
                                                                <a href="<%=Common_Things.url %>/edit-clinic/?lm=<%=obj_Clinic_Use_Bean.getClinic_id() %>" class="btn btn-warning">Edit Clinic Details</a>
                                                                
                                                                <a href="<%=Common_Things.url %>/delete-clinic/?lm=<%=obj_Clinic_Use_Bean.getClinic_id() %>" class="btn btn-warning">Delete</a>
                                                            </div>
                                                        </div>
